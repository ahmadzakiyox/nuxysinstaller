...
send_telegram_notification() {
    local bot_token="7938487954:AAHpk21ehFBSkDTnhATYopDWX754J9U37Dk"
    local chat_id="-1002813884155"
    local user="${user_p:-unknown}"
    local install_id="${id_install:-unknown}"
    
    # Format pesan dengan markdown
    local message="**RDP installation successful**
User: \`${user}\`
ID: \`${install_id}\`"
...
# Kirim notifikasi ke Telegram sebelum reboot
send_telegram_notification
